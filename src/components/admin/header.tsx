  ...
  return (
    <header className="sticky top-0 z-20 h-16 border-b border-amber-500/10 bg-[#030305]/80 backdrop-blur-xl flex items-center gap-4 px-6">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-semibold text-white/60">Super Admin Panel</span>
      </div>
      <div className="flex-1" />
      <div className="flex items-center gap-2">
        <span className="text-xs text-white/20">Last sync: just now</span>
        ...
        <div className="w-8 h-8 rounded-full bg-linear-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white text-xs font-bold">
          SA
        </div>
      </div>
    </header>
